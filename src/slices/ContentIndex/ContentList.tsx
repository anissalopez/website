...
export default function ContentList({
  ...
  return (
    <>
      <ul
        ref={component}
        className="grid border-b border-green"
        ...
        {items.map((post, index) => (
          ...
          >
            <a
              ...
              className="flex flex-col justify-between border-t border-green py-10  text-slate-200 md:flex-row "
            ...
            >
              ...
              <span className={`${myFont.className} text-yellow ml-auto flex items-center gap-2 text-xl font-medium md:ml-0`}>
