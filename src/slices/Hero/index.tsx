...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    <Bounded
      ...
      ref={component}
    >
      <div className={`${myFont.className} grid min-h-[70vh] grid-cols-1 items-center md:grid-cols-2`}>
        <Shapes />
        <div className="col-start-1 md:row-start-1 " data-speed=".2">
          <h1
            className="mb-8 text-[clamp(3rem,20vmin,20rem)]  leading-none tracking-tighter"
            aria-label={
              slice.primary.first_name + " " + slice.primary.last_name
            }
          >
          ...
          <span className="job-title block bg-gradient-to-tr from-yellow via-yellow to-yellow bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 md:text-4xl">
            {slice.primary.tag_line}
          </span>
        </div>
      </div>
